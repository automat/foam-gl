...
var DEFAULT_AUTO_ROTATION_SPEED = 0.00025,
    DEFAULT_AUTO_PAN_SPEED = 0.00125,
...
function CameraOrbiter(camera){
    ...
    mouse.addEventListener(MouseEvent.MOUSE_DOWN,function(e){
        ...
        var mouse = e.sender;
        var mx = 1.0 - mouse.getXNormalized(),
...
/**
 * Sets the auto rotation speed and ondrag behaviour
 * @param speed
 * @param [panRange]
 * @param [stopOnDrag]
 */

CameraOrbiter.prototype.setAutoRotation = function(speed,panRange,stopOnDrag){
    this._autoRotationSpeed = speed;
    this._autoPanRange = panRange === undefined ? this._autoPanRange : panRange;
    this._autoStopOnDrag = stopOnDrag === undefined ? this._autoStopOnDrag : stopOnDrag;
};
...
CameraOrbiter.prototype.apply = function(){
    ...
    var target = this._orientTarget,
        curr   = this._orientCurr,
        result = this._orientResult;

    var autoRotate = this._orientAutoRotate,
