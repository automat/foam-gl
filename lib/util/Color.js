...
Color.prototype.setFromHSV = function(hue,saturatiom,value){
...
Color.prototype.setFromHSB = function(hue,saturation,brightness){
...
Color.prototype.setFromHSBfv = function(hsb){
...
Color.fromHSB = function(hue,saturation,brightness){
    return new Color().setFromHSB(hue,saturation,brightness);
}
...
Color.fromHSBfv = function(hsb){
    return new Color().setFromHSBfv(hsb);
}
