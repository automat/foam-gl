...
function getMGetterSetter(index){
    return {
        set : new Function('return this.m['+index+'];'),
        get : new Function('value','this.m['+index+'] = value;')
    };
}
