...
Vec3.randomPosition = function(){
    ...
    var diff = max - min;
    return new Vec3(min + diff * Random.randomFloat(),
                    min + diff * Random.randomFloat(),
                    min + diff * Random.randomFloat());
};
...
Vec3.randomDirection = function(){
    return Vec3.randomPosition.apply(this,arguments.length ? arguments : RANDOM_DIR_RANGE).normalize();
};
