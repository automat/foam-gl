(function()
{
    ...
    function App(element)
    {
        ...
        var polygon2d = [0,-0.5,0.5,0.5,-0.5,0.5];
        this._polygon2d           = Polygon2dUtil.makePolygon3dFloat32(polygon2d);

        temp = Polygon2dUtil.makeEdgesSubdivided(polygon2d,1);
        this._polygon2dSubDivided = Polygon2dUtil.makePolygon3dFloat32(temp);
        var temp2 = temp.slice();

        /*
        temp = Polygon2dUtil.makeSmoothedLinear(Polygon2dUtil.makeSmoothedLinear(Polygon2dUtil.makeSmoothedLinear(temp2)));
        temp = Polygon2dUtil.makeOptHeading(temp);
        */

        temp = Polygon2dUtil.makeSmoothedLinear(temp,3);
        temp = Polygon2dUtil.makeOptHeading(temp);


       this._polygon2dSmoothedLinear = Polygon2dUtil.makePolygon3dFloat32(temp);
    ...
    App.prototype.update = function()
    {
        ...
        gl.color1f(0.25);
        this.drawPolygon(this._polygon2dSubDivided);

        gl.color1f(1);
        this.drawPolygon(this._polygon2dSmoothedLinear);
