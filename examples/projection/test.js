(function()
{
    ...
    TestApp.prototype.update = function()
    {
        ...
        cam.updateMatrices();
        var screenCoord = gl.getScreenCoord3f(0,0,0);

        div0.style.left = screenCoord[0] + 'px';
        div0.style.top  = screenCoord[1] + 'px';
        div0.innerHTML  = Math.round(screenCoord[0]) + ', ' +
                          Math.round(screenCoord[1]);
    ...
    window.addEventListener('load',function()
    {
        ...
        div0.style.color    = '#fff';
        div0.style.fontFamily = 'arial';
        div0.style.fontSize = '10px';
