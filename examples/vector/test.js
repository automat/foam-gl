(function()
{
    ...
    TestApp.prototype.update = function()
    {
        ...
        var v0 = GLKit.Vec3.make(0,0,0),
            v1 = GLKit.Vec3.make(0.25,0.25,0.25);

        GLKit.GLUtil.drawVector(gl,v0,v1);

        GLKit.Vec3.set3f(v1,Math.cos(time),1,Math.sin(time));
        GLKit.Vec3.set3f(v0,0,0,0);

        GLKit.GLUtil.drawVector(gl,v0,v1);

        GLKit.Vec3.set3f(v0,Math.cos(time),1,Math.sin(time));
        GLKit.Vec3.set3f(v1,Math.cos(time+Math.PI*0.25),1,Math.sin(time+Math.PI*0.25));

        GLKit.GLUtil.drawVector(gl,v0,v1);

        GLKit.Vec3.set3f(v0,Math.cos(time+Math.PI*0.25),1,Math.sin(time+Math.PI*0.25));
        GLKit.Vec3.set3f(v1,Math.cos(time+Math.PI*0.5),1,Math.sin(time+Math.PI*0.5));
