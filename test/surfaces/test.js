(function()
{
    ...
    function TestApp(element)
    {
        ...
        var material = this._material = new GLKit.Material();
        ...
        var surface0 = this._surface0 = new GLKit.ParametricSurface(100);
            ...
            surface0.applyFunctions();
            surface0.updateVertexNormals();
    ...
    TestApp.prototype.update = function()
    {
        ...
        var surface0 = this._surface0,
            surface1 = this._surface1,
        ...
        gl.drawGeometry(surface0);

        material.setDiffuse3f(0.7,0,0);
        material.setAmbient3f(0.7,0,0);
        material.setSpecular3f(1,1,1);
        material.shininess = 20.0;

        gl.material(this._material);
        gl.drawGeometry(surface1);
        ...
        gl.drawMode(gl.LINE_LOOP);
        gl.color1f(0);
        gl.fillColorBuffer(gl.getColorBuffer(),surface0.colors);
        gl.drawGeometry(surface0);
        gl.fillColorBuffer(gl.getColorBuffer(),surface1.colors);
        gl.drawGeometry(surface1);
